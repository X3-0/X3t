#!/usr/bin/env python3
import os, asyncio, socket, struct, hashlib, random, zlib
...
async def handle_client(reader, writer, cipher):
...
async def main():
    ...
    server = await asyncio.start_server(
        lambda r,w: handle_client(r,w, dk.a),
        "0.0.0.0", PORT
    )
    print(f"[*] CAT on port {PORT}")
